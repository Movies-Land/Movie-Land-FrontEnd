...
export class HomePage extends Component {
  ...
  componentDidMount = async () => {
    ...
    let nowPlayingMovie = await axios.get(
      `http://localhost:3001/nowPlayingMovie`
    );
  ...
  render() {
    return (
      <>
        ...
        <MovieStyle>
          <PopularMovie
            popularMovie={this.state.popularMovie}
            show={this.props.show}
            getTrailerForPopularMovie={this.getTrailerForPopularMovie}
          />
        </MovieStyle>

        <MovieStyle>
          <NowPlayingMovie
            nowPlayingMovie={this.state.nowPlayingMovie}
            show={this.props.show}
            getTrailerForNowPlayingMovie={this.getTrailerForNowPlayingMovie}
          />
        </MovieStyle>

        <MovieStyle>
          <TopRatedMovie
            topRatedMovie={this.state.topRatedMovie}
            show={this.props.show}
            getTrailerForTopRatedMovie={this.getTrailerForTopRatedMovie}
          />
        </MovieStyle>
        ...
        <MovieStyle>
          <UpcomingMovie
            ...
            show={this.props.show}
            getTrailerForUpcomingMovie={this.getTrailerForUpcomingMovie}
          />
        </MovieStyle>

        <SearchMovie
          movieSearchData={this.state.movieSearchData}
          showSearch={this.props.showSearch}
          getTrailerForSearch={this.getTrailerForSearch}
